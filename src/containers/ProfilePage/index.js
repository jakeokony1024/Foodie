...
const SideNavigatorItem = (props) => {
    ...
    return (
        <NavLink to={link} className='side-navigator-item' activeClassName='selected'>
    ...
    return (
        <div className='side-navigator' style={{flex:flex}}>
            <SideNavigatorSection sectionTitle='FOODIE'>
                <SideNavigatorItem title='Feed' details='' image='https://cdn-icons-png.flaticon.com/512/25/25694.png' link='/feed'/>
                <SideNavigatorItem title='Recipes' details='Homepage' image='' link='/recipes'/>
                <SideNavigatorItem title='Ingredients' details='Homepage' image='' link='/ingredients'/>
                <SideNavigatorItem title='Creators' details='Homepage' image='' link='/creators'/>
                <SideNavigatorItem title='Blogs' details='Homepage' image='' link='/blogs'/>
            </SideNavigatorSection>
            <SideNavigatorSection sectionTitle='Christian Starr'>
                <SideNavigatorItem title='Profile' details='My Recipes' image='' link='/profile'/>
                <SideNavigatorItem title='RECIPES' details='Homepage' image='' link='/recipes'/>
                <SideNavigatorItem title='Ingredients' details='Homepage' image='' link='/ingredients'/>
            </SideNavigatorSection>
        </div>
